...
import { TCartItem, addItem, minusItem, removeItem } from '../redux/reducers/cartSlice';
...
const CartItem: React.FC<CartItemProps> = ({ id, title, price, types, count, imageUrl, sizes }) => {
